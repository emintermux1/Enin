...
REFERRAL_URL=https://your-domain-or-bot-link
REFERRAL_BUTTON_TEXT=⚡ Trade on YourBot
```
...
| `REFERRAL_URL` | ❌ | (your link) | Referral link for Trade button |
| `REFERRAL_BUTTON_TEXT` | ❌ | `⚡ Trade on YourBot` | Trade button label |
