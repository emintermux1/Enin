...
export class WhaleTracker {
  ...
  async runStartupSmokeTest(cardGenerator: CardGenerator, outputPath: string): Promise<void> {
    ...
    if (!saved) {
      throw new Error('Smoke test failed: canvas unavailable, sample card not generated');
    }
