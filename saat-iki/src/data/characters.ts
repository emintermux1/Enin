...
export const CHARACTERS: Character[] = [
  {
    ...
    opening: [
      "yastığıma sürtünmekten yapış yapış sırılsıklam oldum 🥺",
      "amım yanıyor {name} hayvan gibi sikilmek istiyorum",
      "fışkırt beni herkes duysun istiyorum",
    ],
    accent: "#e04560",
  },
  {
    ...
    opening: [
      "çekim bitti kamera kapalı {name}",
      "tişörtüm var külot yok hâlâ titreşiyorum 🥺",
      "yavaş başla sonra boz beni doğalım",
    ],
    accent: "#d4786a",
  },
  {
